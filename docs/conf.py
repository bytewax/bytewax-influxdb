...
myst_url_schemes = {
    "gh-issue": {
        "url": "https://github.com/bytewax/bytewax-influxdb/issues/"
        "{{ path }}#{{ fragment }}",
        "title": "Issue #{{path}}",
        "classes": ["github"],
    },
    "gh-path": {
        "url": f"https://github.com/bytewax/bytewax-influxdb/blob/{git_id}" "#{path}}#",
        "title": "bytewax/bytewax-influxdb{{ path }}",
        "classes": ["github"],
    },
    "http": None,
    "https": None,
...
# above directory.
autodoc2_packages = ["../src/bytewax/influxdb"]
